...
for i in range(0, len(result), 7):
    split_seven.append(result[i: i + 7])

result_errors = []
for i in split_seven:
    error_index = randrange(0, 7)
    if i[error_index] == '0':
        str1 = i[:error_index] + '1' + i[error_index+1:]
        result_errors.append(str1)
    else:
        str1 = i[:error_index] + '0' + i[error_index+1:]
        result_errors.append(str1)
print(split_seven)
print(result_errors)

str_error = ''
for i in result_errors:
    str_error += i
